...
Sprint 16 implementado en `feature/sprint-16-algorithm-fixes` — versión funcional 1.6. Tests unitarios: 184/184. E2E declarados: 108 tests (CP-01..CP-108). Rama remota: `origin/feature/sprint-16-algorithm-fixes`. Próximo paso: revisión pre-merge y PR contra `main`.
...
- Nueva tabla `Complementos económicos` junto a contadores: recuenta `MF`, `TF`, `N`, `NF` y calcula total con tarifas fijas.
